...
| `XRO_indices_oras5_extended_2025.nc` | ORAS5 ocean reanalysis (ECMWF, via C3S CDS) + XRO indices of Zhao et al. (2024) | Copernicus Products licence (as above) | As above; additionally cite Zhao et al. (2024, Nature 630, 891–898). 1979–2024 bit-identical to the official senclimate/XRO repository indices; the 2025 segment was computed by the authors from ORAS5 monthly fields using the same index definitions and processing pipeline as Zhao et al. (2024). |
